	...
	<div class="viewport">
		<div class="overview">
			...
			<div class="menubox">
				...
				<a href="site.php" target="main">站点配置管理</a>
				...
				<a href="admingroup.php" target="main">管理组管理</a>
				</div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				...
				<a href="maintype.php" target="main">二级类别管理</a>
					<div class="hr_1"> </div>
				...
				<a href="soft.php" target="main">软件下载管理</a>
					<div class="hr_1"> </div>
				<a href="fragment.php" target="main">碎片数据管理</a>
				<a href="diymodel.php" target="main">自定义模型</a>
				<a href="diyfield.php" target="main">自定义字段</a>
				<a href="infoflag.php" target="main">信息标记管理</a>
				<a href="infosrc.php" target="main">信息来源管理</a> </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				...
				<a href="usergroup.php" target="main">用户组管理</a>
				<a href="adtype.php" target="main">广告位管理</a>
				<a href="weblinktype.php" target="main">友情链接类别</a>
				</div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				...
				<a href="getmode.php" target="main">货到方式管理</a> </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				...
				<a href="diymenu.php" target="main">自定义菜单项</a>
					<div class="hr_1"> </div>
				<a href="mobile.php" target="main">手机网站设置</a>
				<a href="editfile.php" target="main">默认模板管理</a>
				</div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				...
				<a href="syscount.php" target="main">数据统计</a>
					<div class="hr_1"> </div>
				<a href="upload_file.php" target="main">上传新文件</a>
				<a href="check_bom.php" target="main">BOM检查</a> 
				<a href="help.php" target="main">开发帮助</a> 
				</div>
			</div>
			<!--scrollbar end-->
		</div>
