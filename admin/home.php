...
<div class="homeTeam">
	...
	<ul>
		<li><strong>程序开发及交互设计：</strong> <i>Gui</i></li>
		<li><strong>技术支持：</strong> <i><?php echo $cfg_jishu;?></i></li>
...
<div class="homeCopy"> 敬请您将在使用中发现的问题或者不适提交给我们，以便改进 <a href="http://new.internet-kf.com/" target="_blank" class="feedback">点击提交反馈</a> | <a href="help.php" class="doc">开发帮助</a> </div>
<?php
